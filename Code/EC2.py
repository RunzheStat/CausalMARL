...
printR("final sd_R trend for [0, 5, 10]  \n")
##########################################################################################################################################################
# rep_times = n_cores
# rep_times = 9
rep_times = 96
...
batch_size = 32
##########################################################################################################################################################
shared_setting = "Basic setting:" + "[T, rep_times, sd_O, sd_D, sd_R, sd_u_O, w_O, w_A, [M_in_R, mean_reversion, poisO, simple, u_O_u_D], sd_R_range] = " + str([T, rep_times, sd_O, sd_D, sd_R, sd_u_O, w_O, w_A, DGP_choice, sd_R_range]) + "\n"
...
with open("0403_sd_R.txt", "wb") as fp:
